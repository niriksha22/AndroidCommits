...
public class MainActivity extends AppCompatActivity {
    ...
    public void onAdd(View view) {
        ...
        //coding challenge to fix the bug when values are empty
        String operandOneString = mOperandOneEditText.getText().toString();
        String operandTwoString = mOperandTwoEditText.getText().toString();
        if (TextUtils.isEmpty(operandOneString) || TextUtils.isEmpty(operandTwoString)) {
            Toast.makeText(this, getString(R.string.empty_operand),
